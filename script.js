...
const translationEntries = [
  ...
  ['research.lead', 'Applied linguistics, second language acquisition, and AI-assisted language learning.', 'Linguistique appliquée, acquisition des langues secondes et apprentissage des langues assisté par l’IA.', '应用语言学、第二语言习得和 AI 辅助语言学习。'],
  ...
  ['software.aboutText', 'EuuuhAI for French is a software project by Sifaks Ousmail, now available on the App Store. The aim is to improve and accelerate French pronunciation learning through AI and new technologies.', 'EuuuhAI for French est un projet logiciel de Sifaks Ousmail, désormais disponible sur l’App Store. Son objectif est d’améliorer et d’accélérer l’apprentissage de la prononciation française grâce à l’IA et aux nouvelles technologies.', '优法音 AI（EuuuhAI for French）是 Sifaks Ousmail 的软件项目，现已在 App Store 上线。目标是通过 AI 和新技术改进并加速法语发音学习。'],
  ...
  ['software.statusText', 'This project is available on the App Store (EuuuhFrench). It also works on PC & Mac. Updated regularly!', 'Ce projet est disponible sur l’App Store (EuuuhFrench). Il fonctionne aussi sur PC et Mac. Mis à jour régulièrement !', '该项目已上线 App Store（EuuuhFrench），同时支持 PC 和 Mac，定期更新！'],
  ...
  ['blog.lead', 'A space for reflections on languages & the development of language learning software.', 'Un espace de réflexion sur les langues et le développement de logiciels d’apprentissage des langues.', '一个关于语言以及语言学习软件开发的反思空间。'],
