...
const translationEntries = [
  ...
  ['home.githubText', 'Explore Sifaks Ousmail’s GitHub profile for projects, code, and ongoing work in language technology, software, and digital development.', 'Explorez le profil GitHub de Sifaks Ousmail pour découvrir des projets, du code et des travaux en cours liés aux technologies du langage, au logiciel et au développement numérique.', '访问 Sifaks Ousmail 的 GitHub 主页，了解语言技术、软件和数字开发相关的项目、代码与持续工作。'],
  ...
  ['software.galleryHome', 'Learning flow preview', 'Aperçu du parcours d’apprentissage', '学习流程预览'],
  ['software.galleryPractice', 'Practice and recording interface', 'Interface de pratique et d’enregistrement', '练习与录音界面'],
  ['software.galleryFeedback', 'AI-assisted feedback preview', 'Aperçu du feedback assisté par l’IA', 'AI 辅助反馈预览'],
  ['software.galleryHomeAlt', 'EuuuhFrench home screen preview', 'Aperçu de l’écran d’accueil EuuuhFrench', 'EuuuhFrench 首页预览'],
  ['software.galleryPracticeAlt', 'EuuuhFrench pronunciation practice and recording screen preview', 'Aperçu de l’écran de pratique et d’enregistrement de prononciation EuuuhFrench', 'EuuuhFrench 发音练习和录音界面预览'],
  ['software.galleryFeedbackAlt', 'EuuuhFrench feedback guidance screen preview', 'Aperçu de l’écran de feedback guidé EuuuhFrench', 'EuuuhFrench 反馈指导界面预览'],
